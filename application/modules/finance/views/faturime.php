                    ...
                    <section>
                        <form role="form" class="f_report" action="finance/faturime" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <?php if ($filter_by != 'department') { ?> 
                                    <div class="col-md-2 no-print hidden form-group" id="department_choose">
                                    <?php } else { ?>
                                ...
                                <script>
                                    $(document).ready(function () {
                                        ...
                                        $('#filter_by').change(function () {
                                            var id = $(this).val();
                                            if (id === 'department') {
                                                $('#department_choose').removeClass('hidden');
                                                $('#type_choose').addClass('hidden');
                                                $('#laboratorist_choose').addClass('hidden');
                                            } else if (id === 'payment_proccedure') {
                                                $('#department_choose').addClass('hidden');
                                                $('#type_choose').removeClass('hidden');
                                                $('#laboratorist_choose').addClass('hidden');
                                            } else if (id === 'laboratorist') {
                                                $('#department_choose').addClass('hidden');
                                                $('#type_choose').addClass('hidden');
                                                $('#laboratorist_choose').removeClass('hidden');
                                            } else {
                                                $('#department_choose').addClass('hidden');
                                                $('#type_choose').addClass('hidden');
                                                $('#laboratorist_choose').addClass('hidden');
