        ...
        <section>
            <div class="panel panel-primary">
                ...
                <div  class="panel-body col-md-5 panel-moree" id="invoice" style="font-size: 10px;">
                    <div class="row invoice-list">
                        ...
                        <div class="col-lg-4 col-sm-4 details">
                            ...
                            <p>
                                <?php echo $settings->title.' '. lang('pharmacy'); ?> <br>
                        ...
                        <div class="col-lg-4 col-sm-4 details pull-right">
                            ...
                            <ul class="unstyled">
                                <li> <?php echo lang('invoice_number'); ?> 		: <strong>00<?php echo $requisition->invoice_id; ?></strong></li>
                        ...
                        <div class="col-lg-4 col-sm-4 details">
                            ...
                            <ul class="unstyled"> 
                                <li><?php echo date('m/d/Y', $requisition->date); ?></li>    
                            </ul>
                        </div>
                    </div>
                    ...
                    <table class="table table-striped table-hover">
                       ...
                       <?php
                            if (!empty($requisition->category_name)) {
                                $category_name = $requisition->category_name;
                                ...
                                foreach ($category_name1 as $category_name2) {
                                    ...
                                    if ($category_name3[1] > 0) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php
                                                $current_medicine = $this->db->get_where('medicine', array('id' => $category_name3[4]))->row();
                    ...
                    <div class="row">
                         <div class="col-lg-6 invoice-block pull-right">
                             <ul class="unstyled amounts">
                                 <li><strong> <?php echo lang('sub_total'); ?>   <?php echo lang('amount'); ?>  : </strong><?php echo $settings->currency; ?> <?php echo $requisition->amount; ?></li>
                    <?php if (!empty($requisition->discount)) { ?>
                    ...
                    <?php } ?>
                                 <li><strong> <?php echo lang('grand_total'); ?>  : </strong><?php echo $settings->currency; ?> <?php echo $requisition->gross_total; ?></li>
                ...
                <div class="col-md-5 panel-moree" style="font-size: 10px;">
                    ...
                    <div class="text-center invoice-btn clearfix">
                        <?php if (empty($requisition->invoice_id)) { ?>
                            <a href="medicine/deleteRequisition?id=<?php echo $requisition->id; ?>" class="btn btn-info btn-lg green pull-left"><i class="fa fa-edit"></i> <?php echo lang('edit_invoice'); ?> </a>
                        <?php } ?>
                    </div>
