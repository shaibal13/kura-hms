                           ...
                           <?php
                            ...
                            if (!empty($inventories->item)) {
                                ...
                                ?><input type="hidden" name="id[]" value="<?php echo $medicine->id; ?>">
                                    ...
                                    <td><input type="text" name="quantity[]" value="<?php echo $item_single[1]; ?>" required=""></td>
                            ...
                            <?php } } ?>
                            <input type="hidden" name="title" value="<?php echo $inventories->title; ?>">
                            <input type="hidden" name="date" value="<?php echo $inventories->date; ?>">
                            <input type="hidden" name="description" value="<?php echo $inventories->description; ?>">
                       <input type="hidden" name="inventory_id" value="<?php echo $inventories->id; ?>">
