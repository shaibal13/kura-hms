                        ...
                        <?php foreach ($categories as $category) { ?>
                            <tr class="">
                                ...
                                if ($this->ion_auth->in_group(array('admin'))) {
                                    $department = $this->department_model->getDepartmentById($category->department);
                                    if (empty($department)) {
                                        ?>
                                ...
                                ?>
                                    ...
                                    <?php if ($this->ion_auth->in_group(array('admin')) || $permis_2 == 'ok') { ?>
                                            <a class="btn btn-info btn-xs btn_width delete_button" href="medicine/deleteInternalMedicineCategory?id=<?php echo $category->id; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash"> <?php echo lang('delete'); ?></i></a>
                                <?php } ?>
                                    </td>
    <?php } ?>
                            </tr>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body row">
                <form role="form" action="medicine/addNewInternalCategory" class="clearfix" method="post" enctype="multipart/form-data">
                            <?php if ($this->ion_auth->in_group(array('admin'))) { ?>
...
<div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body row">
                <form role="form" id="editCategoryForm" action="medicine/addNewInternalCategory" class="clearfix" method="post" enctype="multipart/form-data">
                            <?php if ($this->ion_auth->in_group(array('admin'))) { ?>
                        <div class="form-group col-md-12">
                            <label for="exampleInputEmail1"> <?php echo lang('department'); ?></label>
                            <select class="form-control m-bot15 js-example-basic-single" name="department" value=''>
...
<script type="text/javascript">
                                                $(document).ready(function () {
                                                    $(".editbutton").click(function (e) {
                                                        ...
                                                        $('#myModal2').modal('show');
                                                        $.ajax({
                                                            url: 'medicine/editInternalMedicineCategoryByJason?id=' + iid,
                                                            method: 'GET',
                                                            data: '',
                                                            dataType: 'json',
