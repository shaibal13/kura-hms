...
class Doctor extends MX_Controller {
    ...
    function details() {
        ...
        $data['appointment_patients'] = $this->getPatientByAppointmentByDctorId($id);
        $data['doctors'] = $this->doctor_model->getDoctor();
    ...
    function getDoctor() {
        ...
        foreach ($data['doctors'] as $doctor) {
            ...
            if ($this->ion_auth->in_group(array('admin', 'Accountant', 'Receptionist')) || in_array('Schedule', $this->pers)) {
