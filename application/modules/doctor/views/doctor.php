...
<section id="main-content">
    <section class="wrapper site-min-height">
        ...
        foreach ($permission_access_group_explode as $perm) {
            ...
            if (in_array('2', $perm_explode) && $perm_explode[0] == 'Doctor') {
                $permis = 'ok';
                //  break;
            }
             if (in_array('3', $perm_explode) && $perm_explode[0] == 'Doctor') {
                $permis_2 = 'ok';
                //  break;
            }
        }
        ...
        <section class="panel">
            <header class="panel-heading">
                ...
                <?php  if ($this->ion_auth->in_group(array('admin', 'Accountant', 'Doctor', 'Receptionist', 'Nurse', 'Laboratorist', 'Patient')) || $permis == 'ok') { ?>
                        ...
                        <thead>
                            <tr>
                                ...
                                <th><?php echo lang('profile'); ?></th>
                                     <?php  if ($this->ion_auth->in_group(array('admin', 'Accountant', 'Doctor', 'Receptionist', 'Nurse', 'Laboratorist', 'Patient')) || $permis== 'ok' || in_array('Schedule', $pers)) { ?>
