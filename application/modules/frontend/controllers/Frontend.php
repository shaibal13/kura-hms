...
//            }
    ...
    public function update() {
        ...
        $apppointment_title = $this->input->post('appointment_title');
        $apppointment_subtitle = $this->input->post('appointment_subtitle');
        $apppointment_description = $this->input->post('appointment_description');
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                if ($this->upload->do_upload('img_url')) {
                    ...
                    $data = array(
                        ...
                        'apppointment_title' => $apppointment_title,
                        'apppointment_subtitle' => $apppointment_subtitle,
                        'apppointment_description' => $apppointment_description
                    );
                } else {
                    $data = array();
                    $data = array(
                        ...
                        'skype_id' => $skype_id,
                        'twitter_username' => $twitter_username,
                        'appointment_title' => $apppointment_title,
                        'appointment_subtitle' => $apppointment_subtitle,
                        'appointment_description' => $apppointment_description
                    );
                }
                //  print_r($data);
                //    die();
