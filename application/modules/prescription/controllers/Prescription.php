...
class Prescription extends MX_Controller {
    ...
    function __construct() {
        ...
        if ($group_permission->name == 'admin' || $group_permission->name == 'Patient' || $group_permission->name == 'Doctor' || $group_permission->name == 'Nurse' || $group_permission->name == 'Pharmacist' || $group_permission->name == 'Laboratorist' || $group_permission->name == 'Accountant' || $group_permission->name == 'Receptionist' || $group_permission->name == 'members') {
         ...
         if ($this->ion_auth->in_group(array('Receptionist', 'Accountant', 'Laboratorist'))) {
    ...
    function all() {
        ...
        if (!$this->ion_auth->in_group(array('admin', 'Doctor', 'Pharmacist')) && !in_array("Prescription", $this->pers)) {
            redirect('home/permission');
        }
    ...
    function getPrescriptionList() {
       ...
       // $permis_1 = '';
        ...
        foreach ($data['prescriptions'] as $prescription) {
            ...
            if ($this->ion_auth->in_group(array('Pharmacist', 'Receptionist')) || in_array('Prescription', $this->pers)) {
                $option3 = '';
                
            }
              if ($this->ion_auth->in_group(array('Pharmacist', 'Receptionist')) || $permis_2 !='ok') {
                $option2 = '';
