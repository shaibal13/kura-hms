                ...
                <div class="adv-table editable-table ">
                    <div class="clearfix row">
                        ...
                        <form role="form" action="settings/update" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group col-md-6">
                                <label for="exampleInputEmail1"><?php echo lang('live'); ?> <?php echo lang('appointment'); ?> <?php echo lang('type'); ?></label>
                                <select class="form-control m-bot15" name="live_appointment_type" value=''>
                                    <option value="jitsi" <?php
                            if (!empty($settings->live_appointment_type)) {
                                if ($settings->live_appointment_type == 'jitsi') {
                                    echo 'selected';
                                }
                            }
                            ?>>Jitsi Meet</option>
                            ...
                            if (!empty($settings->live_appointment_type)) {
                                if ($settings->live_appointment_type == 'zoom') {
                                    echo 'selected';
                                }
                            }
                            ?>>Zoom Meet</option>
