...
class Donor extends MX_Controller {
    ...
    function __construct() {
       ...
       if ($this->ion_auth->in_group(array('pharmacist', 'Receptionist', 'Accountant'))) {
    ...
    public function index() {
        if (!$this->ion_auth->in_group(array('admin', 'Nurse', 'Laboratorist', 'Doctor', 'Patient'))&& !in_array('Donor', $this->pers)) {
            redirect('home/permission');
        }
