                ...
                <div  class="panel-body col-md-5 panel-moree" id="invoice" style="font-size: 10px;">
                    <div class="row invoice-list">
                        ...
                        <div class="col-lg-4 col-sm-4 details">
                            ...
                            <p>
                                <?php echo $supply->vendor_name; ?> <br>
                                <?php echo $supply->address; ?><br>
                                Tel:  <?php echo $supply->phone; ?>
                            </p>
                        </div>
                        ...
                        <div class="col-lg-4 col-sm-4 details pull-right">
                            ...
                            <ul class="unstyled">
                                <li> <?php echo lang('invoice_number'); ?> 		: <strong>00<?php echo $supply->id; ?></strong></li>
                        ...
                        <div class="col-lg-4 col-sm-4 details">
                            ...
                            <ul class="unstyled"> 
                                <li><?php echo date('m/d/Y', $supply->date); ?></li>    
                            </ul>
                        </div>
                    </div>
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <?php
                            if (!empty($supply->supply_medicine)) {
                                $supply_medicine = $supply->supply_medicine;
                                $supply_medicine1 = explode(',', $supply_medicine);
                                $i = 0;
                                foreach ($supply_medicine1 as $supply_medicine2) {
                                    $supply_medicine3 = explode('*', $supply_medicine2);
                                    if ($supply_medicine3[4] > 0) {
                                        ?>                
                                        <tr>
                                            <td><?php echo $i = $i + 1; ?></td>
                                            <td><?php
                                                $current_medicine = $this->db->get_where('medicine', array('id' => $supply_medicine3[0]))->row();
                                           ...
                                           <!-- <td class=""><?php echo $settings->currency; ?> <?php echo $category_name3[1]; ?> </td>-->
                                            <td class=""> <?php echo $supply_medicine3[4]; ?> </td>
                    ...
                    <div class="col-md-12 invoice_footer">
                        <div class="col-md-4 row pull-left" style="">
                            <?php echo lang('created_by'); ?> : <?php echo $this->db->get_where('users',array('id'=>$supply->user))->row()->username; ?>
                ...
                <div class="col-md-5 panel-moree" style="font-size: 10px;">
                    ...
                    <div class="text-center invoice-btn clearfix">
                        <?php if ($this->ion_auth->in_group(array('admin', 'Pharmacist'))) { ?>
                            <a href="supply/editSupply?id=<?php echo $supply->id; ?>" class="btn btn-info btn-lg green pull-left"><i class="fa fa-edit"></i> <?php echo lang('edit_invoice'); ?> </a>
                        <?php } ?>
                    </div>
